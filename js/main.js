...
L.Control.submitControl = L.Control.extend({
	onAdd: function(map) {
		...
		content.innerHTML = '<form onInput = checkForRequiredFields();><input id="currentLocationButton" class="btn" type="button" src="js/main.js" onclick="addPointAtCurrentLocation();" value="Use Current Location" disabled><input id="clickPointButton" class="btn" type="button" onclick="drawPoint();" value="Click a Point"><br><div id="fieldLabel"><label>Username:</label></div><input type="text" id="username"><div id="fieldLabel"><label>Latitude:</label></div><input type="text" id="latitude" disabled><div id="fieldLabel"><label>Longitude:</label></div><input type="text" id="longitude" disabled><div id="fieldLabel"><label>Category:</label></div><select id="categoryDropdown"><option value="default"></option><option value="Wildlife Sighting">Wildlife Sighting</option><option value="Trail Advisory">Trail Advisory</option> <option value="Photogenic Spot">Photogenic Spot</option></select><br><br><textarea id="userComment" rows="3" cols="29" name="comment" placeholder="Comments..."></textarea><br><br><input id="submitButton" class="btn" type="button" value="Submit" onclick="setData();" disabled><input id="resetButton" class="btn" type="reset" value="Reset" onclick="cancelData();"></form>';
